...
export const authApi = {
  signup: (data: { name: string; email: string; password: string; role: "brand" | "creator" }) =>
    api.post<ApiResponse<{ user: unknown; tokens: unknown }>>("/auth/signup", data),

  login: (data: { email: string; password: string }) =>
    api.post<ApiResponse<{ user: unknown; tokens: unknown }>>("/auth/login", data),
...
export const campaignsApi = {
  list: (params?: { status?: string; platform?: string; page?: number; limit?: number }) =>
...
export const creatorsApi = {
  list: (params?: { niche?: string; platform?: string; minFollowers?: number; search?: string; page?: number }) =>
...
export const contractsApi = {
  ...
  reviewDraft: (contractId: string, draftId: string, decision: "approve" | "request_revision", feedback?: string) =>
    api.post(`/contracts/${contractId}/drafts/${draftId}/review`, { decision, feedback }),
...
export const paymentsApi = {
  ...
  verifyPayment: (orderId: string) =>
    api.post("/payments/verify", { orderId }),
